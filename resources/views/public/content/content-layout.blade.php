@section('content')
    ...
    <div class="header-carousel owl-carousel">
        <div class="header-carousel-item">
            <img src="{{ asset('public/img/carousel-1.jpg') }}" class="img-fluid w-100" alt="Image">
        ...
        <div class="header-carousel-item">
            <img src="{{ asset('public/img/carousel-2.jpg') }}" class="img-fluid w-100" alt="Image">
            <div class="carousel-caption">
            ...
            <div class="row g-4">
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="feature-item">
                        <img src="{{ asset('public/img/feature-1.jpg') }}" class="img-fluid rounded w-100"
                            alt="Image">
                ...
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="feature-item">
                        <img src="{{ asset('public/img/feature-2.jpg') }}" class="img-fluid rounded w-100"
                            alt="Image">
                        <div class="feature-content p-4">
                            <div class="feature-content-inner">
                ...
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="feature-item">
                        <img src="{{ asset('public/img/feature-3.jpg') }}" class="img-fluid rounded w-100"
                            alt="Image">
                        <div class="feature-content p-4">
                            <div class="feature-content-inner">
            ...
            <div class="row g-5">
                <div class="col-xl-6 wow fadeInUp" data-wow-delay="0.2s">
                    <div>
                        ...
                        <p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis eligendi
                            illum inventore maiores incidunt vero id. Est ipsam, distinctio veritatis earum inventore ab
                            fugit officiis ut ullam, laudantium facere sapiente?
                        </p>
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="d-flex">
                            ...
                            <div class="row g-0">
                                <div class="col-lg-12">
                                    <div class="rounded mb-4">
                                        <img src="{{ asset('public/img/about.jpg') }}" class="img-fluid rounded w-100"
                                            alt="">
                                    </div>
            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-12 col-xl-4 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="packages-item h-100">
                        ...
                        <p class="mb-5"><i class="fa fa-check text-primary me-2"></i>Win Up To 3 Free All Day
                            Tickets</p>
                ...
                <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="pricing-item bg-dark rounded text-center p-5 h-100">
                        <div class="pb-4 border-bottom">
                            ...
                            <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus,
                                dolorum!</p>
                    ...
                    <div class="pricing-item bg-primary rounded text-center p-5 h-100">
                        <div class="pb-4 border-bottom">
                            ...
                            <p class="text-white mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                Possimus, dolorum!</p>
                            <h2 class="text-dark mb-0">$60,90<span class="text-white fs-5 fw-normal">/person</span>
                            </h2>
                        </div>
            ...
            <div class="row g-4">
                <div class="col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="gallery-item">
                        <img src="{{ asset('public/img/gallery-1.jpg') }}" class="img-fluid rounded w-100 h-100"
                            alt="">
                ...
                <div class="col-md-3 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="gallery-item">
                        <img src="{{ asset('public/img/gallery-2.jpg') }}" class="img-fluid rounded w-100 h-100"
                            alt="">
                        <div class="search-icon">
                ...
                <div class="col-md-3 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="gallery-item">
                        <img src="{{ asset('public/img/gallery-3.jpg') }}" class="img-fluid rounded w-100 h-100"
                            alt="">
                        <div class="search-icon">
                ...
                <div class="col-md-3 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="gallery-item">
                        <img src="{{ asset('public/img/gallery-4.jpg') }}" class="img-fluid rounded w-100 h-100"
                            alt="">
                        <div class="search-icon">
                ...
                <div class="col-md-3 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="gallery-item">
                        <img src="{{ asset('public/img/gallery-5.jpg') }}" class="img-fluid rounded w-100 h-100"
                            alt="">
                        <div class="search-icon">
                ...
                <div class="col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="gallery-item">
                        <img src="{{ asset('public/img/gallery-6.jpg') }}" class="img-fluid rounded w-100 h-100"
                            alt="">
                        <div class="search-icon">
            ...
            <div class="row g-4">
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="blog-item">
                        <div class="blog-img">
                            <a href="#">
                                <img src="{{ asset('public/img/blog-2.jpg') }}" class="img-fluid w-100 rounded-top"
                                    alt="Image">
                            </a>
                        ...
                        <div class="blog-content p-4">
                            ...
                            <p class="mb-4">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ullam
                                aspernatur nam quidem porro sapiente, neque a quibusdam....
                            </p>
                            <a href="#" class="btn btn-primary rounded-pill py-2 px-4">Read More <i
                ...
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="blog-item">
                        <div class="blog-img">
                            <a href="#">
                                <img src="{{ asset('public/img/blog-3.jpg') }}" class="img-fluid w-100 rounded-top"
                                    alt="Image">
                            </a>
                        ...
                        <div class="blog-content p-4">
                            <a href="#" class="h4 d-inline-block mb-4">5 Ways To Enjoy Waterland This Spring
                                Break</a>
                            <p class="mb-4">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ullam
                                aspernatur nam quidem porro sapiente, neque a quibusdam....
                            </p>
                ...
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="blog-item">
                        <div class="blog-img">
                            <a href="#">
                                <img src="{{ asset('public/img/blog-1.jpg') }}" class="img-fluid w-100 rounded-top"
                                    alt="Image">
                            </a>
                            <div class="blog-category py-2 px-4">Insight</div>
                            <div class="blog-date"><i class="fas fa-clock me-2"></i>August 19, 2025</div>
                        ...
                        <div class="blog-content p-4">
                            <a href="#" class="h4 d-inline-block mb-4">3 Tips for Your Family Spring Break at
                                Amusement Park</a>
                            <p class="mb-4">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ullam
                                aspernatur nam quidem porro sapiente, neque a quibusdam....
                            </p>
                    ...
                    <div class="team-item p-4">
                        <div class="team-content">
                            <div class="d-flex justify-content-between border-bottom pb-4">
                                ...
                                <div>
                                    <img src="{{ asset('public/img/team-1.jpg') }}" class="img-fluid rounded"
                    ...
                    <div class="team-item p-4">
                        <div class="team-content">
                            <div class="d-flex justify-content-between border-bottom pb-4">
                                ...
                                <div>
                                    <img src="{{ asset('public/img/team-2.jpg') }}" class="img-fluid rounded"
                                        style="width: 100px; height: 100px;" alt="">
                                </div>
                            </div>
                            <div class="team-icon rounded-pill my-4 p-3">
                    ...
                    <div class="team-item p-4">
                        <div class="team-content">
                            <div class="d-flex justify-content-between border-bottom pb-4">
                                ...
                                <div>
                                    <img src="{{ asset('public/img/team-3.jpg') }}" class="img-fluid rounded"
                                        style="width: 100px; height: 100px;" alt="">
                                </div>
                            </div>
                            <div class="team-icon rounded-pill my-4 p-3">
        ...
        <div class="container py-5">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.2s">
                <div class="testimonial-item p-4">
                    ...
                    <div class="testimonial-inner">
                        <div class="testimonial-img">
                            <img src="{{ asset('public/img/testimonial-1.jpg') }}" class="img-fluid" alt="Image">
                ...
                <div class="testimonial-item p-4">
                    ...
                    <div class="testimonial-inner">
                        <div class="testimonial-img">
                            <img src="{{ asset('public/img/testimonial-2.jpg') }}" class="img-fluid" alt="Image">
                            <div class="testimonial-quote btn-lg-square rounded-circle"><i
                                    class="fa fa-quote-right fa-2x"></i>
                            </div>
                        </div>
                ...
                <div class="testimonial-item p-4">
                    ...
                    <div class="testimonial-inner">
                        <div class="testimonial-img">
                            <img src="{{ asset('public/img/testimonial-3.jpg') }}" class="img-fluid" alt="Image">
                            <div class="testimonial-quote btn-lg-square rounded-circle"><i
                                    class="fa fa-quote-right fa-2x"></i>
                            </div>
                        </div>
