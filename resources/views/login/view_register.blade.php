                        ...
                        <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 m-0">
                                <div class="card-header border-0">
                                    ...
                                    <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2"><span style="font-weight:bold;font-size:15px;">BUAT AKUN LOGIN</span></h6>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ url('register/do_register') }}" method="post" class="form-horizontal form-simple" novalidate>
                                            @csrf
                                            <fieldset class="form-group position-relative has-icon-left mb-0">
                                                <input type="text" class="form-control form-control-lg @error('name') is-invalid @enderror mb-1" name="name" autofocus placeholder="Masukan Nama" type="text" value="{{ old('name') }}">
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left mb-0">
                                                <input type="text" autocomplete="none" class="form-control form-control-lg @error('email') is-invalid @enderror mb-1" name="email" placeholder="Masukkan Email" type="text" value="{{ old('email') }}">
                                                <div class="form-control-position">
                                            ...
                                            <button type="submit" class="btn btn-success btn-lg btn-block"><i class="feather icon-unlock"></i> DAFTAR</button>
                                        </form>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <div class="">
                                        <p class="float-sm-left text-center m-0"><a href="#" data-toggle="modal" data-target="#my-modal" class="card-link">Lupa Password</a></p>
                                        <p class="float-sm-right text-center m-0">Punya Akun ? <a href="{{route('login')}}" class="card-link">Login</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
