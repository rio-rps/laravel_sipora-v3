        ...
        <div class="col-md-6">
            <div class="card  border-success mb-3">
                <figure class="highcharts-figure">
                    <div id="chart-{{ \Illuminate\Support\Str::slug($jenis) }}">
                    </div>
            ...
            Highcharts.chart('chart-{{ \Illuminate\Support\Str::slug($jenis) }}', {
                ...
                series: [{
                    ...
                    point: {
                        events: {
                            click: function() {
                                getDataGrafikDetailTahunan('{{ $data->first()->id_jenis_permohonan }}', this
                                    .category)
                            }
                        }
                    }
...
<script>
    function getDataGrafikDetailTahunan(id, tahun) {
        $.ajax({
            url: "{{ route('panel.show_getDataGrafikDetailTahunan') }}",
            method: 'GET',
            headers: {
