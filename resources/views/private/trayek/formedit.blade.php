<div class="modal fade" id="getModalForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel5" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('cparTrayek.update', $id) }}" class="formData" method="POST">
                @csrf
                ...
                <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select class="form-control" readonly>
                                    <option value="{{ $row->id_par_permohonan }}">
                                        {{ $row->JCparPermohonan->nm_par_permohonan }}</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea name="nm_trayek" class="form-control">{{ $row->nm_trayek }}</textarea>
                            </div>
                        </div>
                    </div>
