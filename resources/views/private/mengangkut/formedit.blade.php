<div class="modal fade" id="getModalForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel5" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('cparMengangkut.update', $id) }}" class="formData" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    <div class="form-body">
                        <div class="form-group row">
                            <label class="col-sm-4 col-form-label border-bottom">Nama Mengangkut</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="nm_mengangkut"
                                    value="{{ $row->nm_mengangkut }}" maxlength="100">
                            </div>
                        </div>
                    </div>
