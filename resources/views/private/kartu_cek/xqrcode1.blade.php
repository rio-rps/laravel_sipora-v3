                    ...
                    <div class="card">
                        <table style="vertical-align: top;" class="table-striped  " style="width:100%;">
                            ...
                            <body>
                                            ...
                                            @if (!empty($row_validasi->tgl_akhir))
                                                ...
                                                @if ($tglAkhir->isBefore(\Carbon\Carbon::today()))
                                                    <span class="badge badge-danger"
                                                        ...
                                                        Masa Berlaku Kartu Pengawas Habis
                                                    </span>

                                                    <div class="text-danger mt-1" style="font-size: 9px;">
                                                        Berakhir {{ $tglAkhir->format('d-m-Y') }}
                                                    </div>
                                                @else
                                ...
                                <td colspan="3" class="bg-info font-weight-bold">
                                    &nbsp; <i class="fa fa-edit"></i>
                                    UJI KENDARAAN BERMOTOR (K I R)
                                </td>

                                <tr>
                                    <td style="vertical-align: top;">Tanggal Awal</td>
                                    <td style="vertical-align: top;">:</td>
                                    <td>{{ isset($row->tgl_kir_awal) ? cek_ddmmyy_v1($row->tgl_kir_awal) : '-' }}
                                    </td>
                                </tr>
                                <tr>
                                    <td style="vertical-align: top;">Masa Berlaku KIR s/d</td>
                                    <td style="vertical-align: top;">:</td>
                                    <td>{{ isset($row->tgl_kir_akhir) ? cek_ddmmyy_v1($row->tgl_kir_akhir) : '-' }}
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="vertical-align: top;">Tanggal Awal</td>
                                    <td style="vertical-align: top;">:</td>
                                    <td>{{ isset($row->tgl_pkb_awal) ? cek_ddmmyy_v1($row->tgl_pkb_awal) : '-' }}
                                    </td>
                                </tr>
                                <tr>
                                    <td style="vertical-align: top;">Masa Berlaku PKB s/d</td>
                                    <td style="vertical-align: top;">:</td>
                                    <td>{{ isset($row->tgl_pkb_akhir) ? cek_ddmmyy_v1($row->tgl_pkb_akhir) : '-' }}
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="vertical-align: top;">Tanggal Awal</td>
                                    <td style="vertical-align: top;">:</td>
                                    <td>{{ isset($row->tgl_iwkbu_awal) ? cek_ddmmyy_v1($row->tgl_iwkbu_awal) : '-' }}
                                    </td>
                                </tr>
                                <tr>
                                    <td style="vertical-align: top;">Masa Berlaku IWKBU s/d</td>
                                    <td style="vertical-align: top;">:</td>
                                    <td>{{ isset($row->tgl_iwkbu_akhir) ? cek_ddmmyy_v1($row->tgl_iwkbu_akhir) : '-' }}
                                    </td>
                                </tr>
