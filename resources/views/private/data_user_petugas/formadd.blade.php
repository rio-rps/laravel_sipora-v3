<div class="modal fade" id="getModalForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel5" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('dataUserPetugas.store') }}" class="formData" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    <div class="form-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="name" maxlength="225">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label border-bottom">Email</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="email" maxlength="225">
                            </div>
                        </div>
                    </div>
                </div>
