             ...
             <div class="btn-group" role="group">
                 ...
                 <div class="dropdown-menu" aria-labelledby="btnGroupDrop2" x-placement="bottom-start"
                     ...
                     <a class="dropdown-item" id="tombolModalForm"
                         data-url="{{ route('dataUserPetugas.editEmail', $model->id) }}" title="Edit e-Mail"><i
                             class="fa fa-user"></i> Edit Email</a>
                     <a class="dropdown-item" id="tombolModalForm"
                         data-url="{{ route('dataUserPetugas.editResetPassword', $model->id) }}"
                         title="Reset Password"><i class="fa fa-unlock"></i> Reset Password
                     </a>
                     <a class="dropdown-item" href="#" id="tombolModalForm"
                         data-url="{{ route('userdataakseskabkota.index', ['id' => $model->id]) }}" title="Kab/ Kota"><i
                             class="fa fa-th-list"></i> Akses Kab/ Kota</a>
                 </div>
             </div>
         </div>
     </div>
