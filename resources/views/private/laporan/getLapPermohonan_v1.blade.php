...
<div class="form-group">
    <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
        <button onclick="openPrintPopup()" class="btn btn-outline-success">
            <i class="fa fa-file-pdf-o"></i> CETAK DOKUMEN
        </button>
        {{--  <a target="_blank"
            href="{{ route('laporan.cetakPermohonanFilter', ['jenisPermohonan' => $ket['jenisPermohonanFilter'], 'sttsPermohonan' => $ket['sttsPermohonanFilter'], 'id_kabkotaFilter' => $ket['id_kabkotaFilter'], 'tglFilter' => $ket['dateFilter']]) }}"
            class="btn btn-outline-success"><i class="fa fa-file-pdf-o"></i> CETAK DOKUMEN</a>  --}}
        <a target="_blank"
...
<script>
    function openPrintPopup() {
        ...
        const newWindow = window.open(
            url,
            '_blank',
            `toolbar=no,scrollbars=yes,resizable=yes,width=${popupWidth},height=${popupHeight},top=${top},left=${left}`
        );

        // Tunggu hingga popup selesai dimuat, lalu cetak
