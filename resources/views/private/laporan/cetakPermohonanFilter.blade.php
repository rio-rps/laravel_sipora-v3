<style>
    .font-custom {
        font-size: {{ $ket['font_size'] }}px;
        font-family: {{ $ket['font_family'] }};
    }
    ...
    .garis-horizontal {
        ...
        margin: 20px 0;
        box-shadow: 0 1px 2px rgba(10, 4, 4, 0.2);
    }
</style>
...
<div style="border-bottom: 2px solid #000; margin-bottom:5px;margin-top:5px;"></div>
    ...
    <thead>
        <tr>
            ...
            @if ($status_permohonan == 5)
                ...
                <th><span class="single-line">Tgl PKB Awal</span><br><span class="single-line">Tgl PKB Akhir</span>
                </th>
                <th><span class="single-line">Tgl IWKBU Awal</span><br><span class="single-line">Tgl IWKBU
                        Akhir</span>
                </th>
            @endif
            <th>Perusahaan</th>
