...
@section('isi')
    ...
    <div class="stiker-container">
        ...
        <div class="download-row">
            <button onclick="downloadImage('depan','png')" class="btn btn-png">🖼️ Download PNG</button>
            <button onclick="downloadImage('depan','jpg')" class="btn btn-jpg">🖼️ Download JPG</button>
    ...
    <div class="stiker-container">
            ...
            <div class="kartu-content">
                ...
                <table class="small-note"
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 5px;">Tanggap terhadap kebutuhan masyarakat akan pelayanan jasa yang
                            tertib,
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 5px;">Terampil dan berperilaku jujur, gesit, ramah, sopan, serta lugas.
                        </td>
                    </tr>
                    <tr>
                        <td style="vertical-align: top; padding-right: 5px;">5.</td>
                        <td style="padding-left: 5px;">Tanggung jawab terhadap keselamatan dan keamanan jasa perhubungan.
                        </td>
                    </tr>
                    <tr>
        ...
        <div class="download-row">
            <button onclick="downloadImage('belakang','png')" class="btn btn-png">🖼️ Download PNG</button>
            <button onclick="downloadImage('belakang','jpg')" class="btn btn-jpg">🖼️ Download JPG</button>
    ...
    <div class="stiker-container">
        ...
        <div class="stiker-container">
            <!-- Bungkus SVG di dalam div supaya bisa di-capture -->
            <div id="capture" style="background:white; padding:10px;">
                <svg width="400" height="400" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Jalur teks melengkung -->
                    <path id="title" d="M 50 190 A 150 150 0 0 1 350 190" fill="none" />
                    <path id="title2" d="M 70 200 A 115 115 0 0 1 340 215" fill="none" />

                    <!-- Teks utama (Trebuchet MS Bold) -->
                    <text font-family="'Trebuchet MS', sans-serif" font-weight="bold" font-size="25" fill="#000"
                        text-anchor="middle">
                        <textPath href="#title" startOffset="50%">
                            @php
                                $jenis = 'ANGKUTAN KHUSUS BATUBARA';
                                $title2 = $row->JPermohonan->nm_perusahaan_personal;
                                $plat = $row->JPermohonan->plat_no_kendaraan;
                            @endphp
                            {{ \Illuminate\Support\Str::limit(strtoupper($jenis), 26) }}
                        </textPath>
                    </text>

                    <!-- Nama perusahaan -->
                    <text font-family="'Trebuchet MS', sans-serif" font-weight="bold" font-size="18" fill="#000"
                        text-anchor="middle">
                        <textPath href="#title2" startOffset="50%">
                            {{ \Illuminate\Support\Str::limit(strtoupper($title2), 32) }}
                        </textPath>
                    </text>
                    ...
                    <text x="283" y="205" font-family="'Trebuchet MS', sans-serif" font-weight="bold" font-size="19"
                        fill="#000">
                        {{ \Illuminate\Support\Str::limit(strtoupper($plat), 11) }}
                    </text>
                </svg>
            </div>
