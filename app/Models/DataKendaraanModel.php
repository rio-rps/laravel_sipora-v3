...
class DataKendaraanModel extends Model
{
    ...
    protected $fillable = [
        'id_merek_kendaraan', 'id_type_kendaraan', 'nm_kendaraan', 'plat_no_kendaraan', 'daya_angkut_orang', 'daya_angkut_barang',
        'thn_pembuatan', 'no_rangka', 'no_mesin', 'id_biodata', 'jenis_biodata', 'id_biodata', 'status_actived', 'file_kir', 'file_stnk'
    ];
